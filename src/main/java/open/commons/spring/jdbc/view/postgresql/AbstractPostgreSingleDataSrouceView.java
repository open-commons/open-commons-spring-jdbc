 ...
 * @author parkjunhong77@gmail.com
 */
public abstract class AbstractPostgreSingleDataSrouceView<T> extends AbstractSingleDataSourceView<T> {
     ...
     * @author parkjunhong77@gmail.com
     */
    public AbstractPostgreSingleDataSrouceView(@NotNull Class<T> entityType) {
