 ...
 * @author parkjunhong77@gmail.com
 */
public abstract class AbstractOracleSingleDataSourceView<T> extends AbstractSingleDataSourceView<T> {
     ...
     * @author parkjunhong77@gmail.com
     */
    public AbstractOracleSingleDataSourceView(@NotNull Class<T> entityType) {
     ...
     * @author parkjunhong77@gmail.com
     */
    public AbstractOracleSingleDataSourceView(@NotNull Class<T> entityType, boolean forceToPrimitive) {
     ...
     * @author parkjunhong77@gmail.com
     */
    public AbstractOracleSingleDataSourceView(@NotNull Class<T> entityType, boolean forceToPrimitive, boolean ignoreNoDataMethod) {
